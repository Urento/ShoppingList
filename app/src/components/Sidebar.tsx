  ...
  const logout = async () => {
    ...
    if (fJson.message !== "fail" && fJson.data.success === "true") {
      swal({
        ...
        text: "You were successfully logged out! You will be redirected in 5 seconds!",
      });
    } else {
      swal({
        icon: "error",
        title: "Logout not successful!",
          ...
          <ul className="mt-12">
            ...
            >
              <div className="flex items-center">
                ...
                <span className="text-sm  ml-2">New Shoppinglist</span>
              </div>
            </li>
            <li
              className="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6"
              onClick={() => history.push("/participants/invitations")}
            >
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-sm  ml-2">View Invitations</span>
              </div>
            </li>
          </ul>
        </div>
